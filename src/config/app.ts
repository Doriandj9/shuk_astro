import type {AppConfig} from '@/config/@types/app';
import type { DocStatus as DocStatusType } from '@/modules/core/@types/core';
import type { User } from '@/modules/web/@types/web';
import type { ThemeOptions } from "@mui/material";
import axios from 'axios';

const host = import.meta.env.PUBLIC_API_URL;
const versionApp = import.meta.env.PUBLIC_APP_VERSION;
const endPointApi = import.meta.env.PUBLIC_ENDPOINT_API;
const apiWhatsAppHost = import.meta.env.PUBLIC_API_WHATSAPP_URL;
const shareFacebookHost = import.meta.env.PUBLIC_API_FACEBOOK_URL || 'https://www.facebook.com/sharer/sharer.php';
const idFacebook = import.meta.env.PUBLIC_FACEBOOK_ID || '1179066826681637';
const idGoogle = import.meta.env.PUBLIC_GOOGLE_ID || '1179066826681637';
const hostApp = import.meta.env.PUBLIC_APP_HOST || ''; //(new URL(window.location.href)).origin;
const emailContact = import.meta.env.PUBLIC_EMAIL_CONTACT || ''; //(new URL(window.location.href)).origin;

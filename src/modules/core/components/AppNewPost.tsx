...
import type { ContentFormPost } from "../@types/post";
...
import  type { StoreNotificationUser } from "@/modules/web/hooks/notifications/notifications";
    ...
    <>
      ...
      >
        ...
        <div className="app-insert-post">
          ...
          >
            <img src={imgPost.src} className="w-12 h-12" />

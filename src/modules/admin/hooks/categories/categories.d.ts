import type { ResponseCreateApi, ResponseSuccessApi, ResponseUpdateApi } from "@/modules/core/@types/core";
import type { InfinityData } from "@/modules/web/@types/web";
import type { DocStatusData } from "@/modules/web/hooks/post/PostI";
import type { NewCategoriesForm } from "@/modules/web/validations/categoriesSchema";
